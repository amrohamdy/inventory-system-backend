...
const PERMISSIONS = {
    ...
    GRN_MANAGE: ['ADMIN', 'STOREKEEPER', 'COST_CONTROL'],
    ...
    APPROVE_BREAKAGE: ['ADMIN', 'DEPT_MANAGER', 'COST_CONTROL', 'FINANCE_MANAGER', 'GENERAL_MANAGER'],
    ...
    APPROVE_LOST: ['ADMIN', 'DEPT_MANAGER', 'COST_CONTROL', 'FINANCE_MANAGER', 'GENERAL_MANAGER'],
    REPORTS_EXPORT: [
        'ADMIN',
        'STOREKEEPER',
        'COST_CONTROL',
    ...
    GET_PASS_CONFIRM_DESTINATION: ['ADMIN', 'SECURITY', 'GENERAL_MANAGER'],
    ...
    AUDIT_LOG_VIEW: ['ADMIN', 'FINANCE_MANAGER', 'AUDITOR', 'GENERAL_MANAGER'],
};
